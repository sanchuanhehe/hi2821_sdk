...
#define BTC_CUSTOMIZE_ID 0xC
#define SLDM_CONFIG_NV_INFO_ID 0xF
#define SLDM_CONFIG_NV_POSALG_ID 0x10
#define SLDM_CONFIG_NV_POS_IN_OUT_ID 0x20
#define SLDM_CONFIG_NV_DISCBK_ID 0x30
