...
component_set = {
    ...
    'media_mini': ['audio_hw', 'audio_primary_port', 'audio_bluetooth_port', 'audio_port_common',
              'media_hal_common', 'tone_player', 'media_sample_wrapper'],
    'media_target4': ['audio_manager', 'audio_service', 'audio_stream', 'audio_utils', 'media_common', 'audio_hw',
              'audio_primary_port', 'audio_bluetooth_port', 'audio_modem_port', 'media_hal_common', 'audio_port_common'],
    'gpu': ['gfx_rm', 'gpu'],
    'gpu_test': ['test_gpu'],
    ...
    'app_ux': ['ux_audio', 'ux_bt', 'ux_commu', 'ux_sensor', 'ux_spp', 'ux_cmn_header'],
    ...
    'ux_manager': ['fsm_box', 'fsm_master', 'fsm_pairing', 'ux_event', 'ux_earphone', 'ux_timer', 'ux_tone', "ux_led",
                   'ux_master', 'at_ux_manager', 'at_ux_register', 'ux_voiceassistant'],
    ...
    'codec_set': ['sbc_dec_itcm', 'sbc_dec', 'sbc_enc_itcm', 'sbc_enc', 'opus_enc_itcm', 'opus_enc_flash',
                  'opus_dec_itcm', 'opus_dec_flash', 'codec_framework'],
    'ohos_set' : ['bootstrap', 'samgr', 'ams', 'bms', 'ace', 'ace_adapt', 'permission', 'appverify', 'jerryscript','js_player', 'js_audio_captuer','i18n', 'resmgr', 'syspara'],
...
defines_set = {
    ...
    'chip_defines': [
        ...
        "TARGET_CHIP_LIBRA=0", "CHIP=1", "CHIP_VERSION=1", "CHIP_WS63=0", "CHIP_BS20=0", "CHIP_BS21=0", "CHIP_BS21A=0",
        "CHIP_BS22=0", "CHIP_BS26=0", "CHIP_WS53=0", "CONFIG_UART_SUPPORT_TX", "CONFIG_UART_SUPPORT_RX"],
    'version_defines': [],
