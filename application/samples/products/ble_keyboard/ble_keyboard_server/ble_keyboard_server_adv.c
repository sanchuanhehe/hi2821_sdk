 ...
 *
 * Description: BLE KEYBOARD Server adv Source. \n
...
uint8_t g_local_name[NAME_MAX_LENGTH] = { 'b', 'l', 'e', '_', 'k', 'e', 'y', 'b', 'o', 'a', 'r', 'd'};
...
uint8_t ble_keyboard_set_adv_data(void)
{
    ...
    if (gap_ble_set_adv_data(BTH_GAP_BLE_ADV_HANDLE_DEFAULT, &cfg_adv_data) != 0) {
        return 0;
    }
    return 0;
}
