...
uint16_t g_device_keyboard_appearance_value = GAP_BLE_APPEARANCE_TYPE_KEYBOARD;
static uint8_t g_device_keyboard_name_value[32] = {'K', 'e', 'y', 'b', 'o', 'a', 'r', 'd', '6', 'x', '\0'};
...
bool bts_compare_uuid(bt_uuid_t *uuid1, bt_uuid_t *uuid2)
{
