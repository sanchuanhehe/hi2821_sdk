 ...
 *
 * Description: Sle Air Mouse with dongle server adv header. \n
 * Author: @CompanyNameTag \n
 * History: \n
 * 2023-11-16, Create file. \n
 */

#ifndef SLE_AIR_MOUSE_SERVER_ADV_H
#define SLE_AIR_MOUSE_SERVER_ADV_H
...
#define SLE_AIR_MOUSE_DONGLE_SERVER_LOG                     "[sle air mouse dongle server]"
