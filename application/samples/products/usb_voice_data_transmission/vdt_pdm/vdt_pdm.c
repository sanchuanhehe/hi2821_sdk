...
#if defined(CONFIG_USB_PDM_DMIC_4)
    mic = HAL_PDM_DMIC_4;
#elif defined(CONFIG_USB_PDM_DMIC_5)
    mic = HAL_PDM_DMIC_5;
#elif defined(CONFIG_USB_PDM_DMIC_DUAL)
...
int32_t vdt_pdm_start_dma_transfer(uint32_t *pcm_buffer, dma_transfer_cb_t trans_done)
{
    ...
    transfer_config.transfer_num = CONFIG_USB_PDM_TRANSFER_LEN_OF_DMA;
