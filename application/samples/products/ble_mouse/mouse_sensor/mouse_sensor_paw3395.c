...
const spi_mouse_cfg_t g_ble_paw3395db_cfg[] = {
...
{
    mouse_sensor_spi_open(0, 0, 0, SPI_FREQUENCY);
    mouse_sensor_spi_opration(g_ble_paw3395db_cfg, sizeof(g_ble_paw3395db_cfg)/ sizeof(spi_mouse_cfg_t));
    paw3395_chaneg_dpi();
...
mouse_sensor_oprator_t g_ble_paw3395_operator = {
