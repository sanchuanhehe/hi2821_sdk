...
#include <stdint.h>
#include "hal_efuse_v100_reg_def.h"
...
extern efuse_regs_t *g_efuse_v100_regs[EFUSE_REGION_NUM];
 ...
 */
static inline uint32_t hal_efuse_ctl_get(hal_efuse_region_t region)
{
    efuse_ctl_data_t efuse_ctl;
    efuse_ctl.d32 = g_efuse_v100_regs[region]->efuse_ctl_data.d32;
...
static inline void hal_efuse_ctl_set_wr_rd(hal_efuse_region_t region, uint32_t val)
{
    ...
    g_efuse_v100_regs[region]->efuse_ctl_data.d32 = efuse_ctl.d32;
}
 ...
 */
static inline uint32_t hal_efuse_clk_period_get(hal_efuse_region_t region)
{
    efuse_period_data_t efuse_period;
    efuse_period.d32 = g_efuse_v100_regs[region]->efuse_clk_period_data.d32;
...
static inline void hal_efuse_clk_period_set_clk(hal_efuse_region_t region, uint32_t val)
{
    ...
    g_efuse_v100_regs[region]->efuse_clk_period_data.d32 = efuse_period.d32;
}

/**
 * @brief  Get the value of @ref efuse_mr_data.mode.
 * @return The value of @ref efuse_mr_data.mode.
 */
static inline uint32_t hal_efuse_mr_data_get_mode(hal_efuse_region_t region)
{
    efuse_mr_data_t efuse_mr;
    efuse_mr.d32 = g_efuse_v100_regs[region]->efuse_mr_data.d32;
    return efuse_mr.b.mode;
}

/**
 * @brief  Set the value of @ref efuse_mr_data.mode.
 * @param  [in]  val The value of @ref efuse_mr_data.mode
 */
static inline void hal_efuse_mr_data_set_mode(hal_efuse_region_t region, uint32_t val)
{
    efuse_mr_data_t efuse_mr;
    efuse_mr.d32 = g_efuse_v100_regs[region]->efuse_mr_data.d32;
    efuse_mr.b.mode = val;
    g_efuse_v100_regs[region]->efuse_mr_data.d32 = efuse_mr.d32;
}
