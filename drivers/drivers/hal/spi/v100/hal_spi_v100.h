 ...
 */
#ifndef HAL_SPI_V100_H
#define HAL_SPI_V100_H
...
/**
 * @if Eng
 * @brief  Get the interface of spi_v100_funcs.
 * @return The interface of spi_v100_funcs.
 * @else
 * @brief  获取spi_v100_funcs接口实例。
 * @return spi_v100_funcs接口实例。
 * @endif
 */
