...
/**
 * @brief  Deinit the hal_keyscan which will clear the base address of registers has been
 *         set by @ref hal_keyscan_v150_regs_init.
 */
...
static inline uint16_t hal_keyscan_get_key_value(void)
{
    ...
    g_keyscan_regs->key_value_fifo = key_value_fifo.d32;
