 ...
 * @endif
 */
typedef errcode_t (*hal_i2c_master_init_t)(i2c_bus_t bus, uint32_t baudrate,
 ...
 * @endif
 */
typedef errcode_t (*hal_i2c_slave_init_t)(i2c_bus_t bus, uint32_t baudrate,
 ...
 * @endif
 */
typedef errcode_t (*hal_i2c_deinit_t)(i2c_bus_t bus);
 ...
 * @endif
 */
typedef errcode_t (*hal_i2c_ctrl_t)(i2c_bus_t bus, hal_i2c_ctrl_id_t id, uintptr_t param);
 ...
 * @endif
 */
typedef errcode_t (*hal_i2c_write_t)(i2c_bus_t bus, hal_i2c_buffer_wrap_t *data);
 ...
 * @endif
 */
typedef errcode_t (*hal_i2c_read_t)(i2c_bus_t bus, hal_i2c_buffer_wrap_t *data);

/**
 * @if Eng
 * @brief  Interface between I2C driver and I2C hal.
 * @else
 * @brief  Driver层I2C和HAL层I2C的接口
 * @endif
 */
typedef struct {
    hal_i2c_master_init_t master_init;     /*!< @if Eng Init device interface for master.
                                                @else   HAL层I2C的主机的初始化接口。 @endif */
    hal_i2c_slave_init_t slave_init;       /*!< @if Eng Init device interface for slave.
                                                @else   HAL层I2C的从机的初始化接口。 @endif */
    hal_i2c_deinit_t deinit;               /*!< @if Eng Deinit device interface.
                                                @else   HAL层I2C去初始化接口。 @endif */
    hal_i2c_ctrl_t ctrl;                   /*!< @if Eng Control device interface.
                                                @else   HAL层I2C控制接口。 @endif */
    hal_i2c_write_t write;                 /*!< @if Eng Write data interface.
                                                @else   HAL层I2C发送数据接口。 @endif */
    hal_i2c_read_t read;                   /*!< @if Eng Read data interface.
                                                @else   HAL层I2C读取数据接口。 @endif */
} hal_i2c_funcs_t;

/**
 * @if Eng
 * @brief  Register @ref hal_i2c_funcs_t into the g_hal_i2cs_funcs.
 * @param  [in]  bus The I2C bus. see @ref i2c_bus_t
 * @param  [in]  funcs Interface between I2C driver and I2C hal. see @ref hal_i2c_funcs_t
 * @retval ERRCODE_SUCC Success.
 * @retval Other        Failure. For details, see @ref errcode_t
 * @else
 * @brief  注册 @ref hal_i2c_funcs_t 到 g_hal_i2cs_funcs。
 * @param  [in]  bus I2C索引。参考 @ref i2c_bus_t
 * @param  [in]  funcs Driver层I2C和HAL层I2C的接口实例。参考 @ref hal_i2c_funcs_t
 * @retval ERRCODE_SUCC 成功。
 * @retval Other        失败。参考 @ref errcode_t
 * @endif
 */
...
/**
 * @if Eng
 * @brief  Unregister @ref hal_i2c_funcs_t from the g_hal_i2cs_funcs.
 * @param  [in]  bus The I2C bus. see @ref i2c_bus_t
 * @retval ERRCODE_SUCC Success.
 * @retval Other        Failure. For details, see @ref errcode_t
 * @else
 * @brief  从g_hal_i2cs_funcs注销 @ref hal_i2c_funcs_t
 * @param  [in]  bus I2C索引。参考 @ref i2c_bus_t
 * @retval ERRCODE_SUCC 成功。
 * @retval Other        失败。参考 @ref errcode_t
 * @endif
...
/**
 * @if Eng
 * @brief  Get interface between I2C driver and I2C hal. see @ref hal_i2c_funcs_t
 * @param  [in]  bus The I2C bus. see @ref i2c_bus_t
 * @return Interface between I2C driver and I2C hal. see @ref hal_i2c_funcs_t
 * @else
 * @brief  获取Driver层I2C和HAL层I2C的接口实例。参考 @ref hal_i2c_funcs_t
 * @param  [in]  bus I2C索引。参考 @ref i2c_bus_t
 * @return Driver层I2C和HAL层I2C的接口实例。参考 @ref hal_i2c_funcs_t
 * @endif
 */
