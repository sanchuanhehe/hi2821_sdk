...
/**
 * @brief  Set the value of @ref pdm_v150_hpf_ctrl_data.hpd_fs_sel.
 * @param  [in]  mic The mic need to configure.
 * @param  [in]  val The value of @ref pdm_v150_hpf_ctrl_data.hpd_fs_sel.
 */
static inline void hal_pdm_v150_hpf_ctrl_set_hpd_fs_sel(uint8_t mic, uint32_t val)
{
    pdm_v150_hpf_ctrl_data_t hpf_ctrl;
    hpf_ctrl.d32 = ((pdm_v150_regs_t *)g_hal_pdm_regs)->hpf_ctrl[mic];
    hpf_ctrl.b.hpd_fs_sel = val;
    ((pdm_v150_regs_t *)g_hal_pdm_regs)->hpf_ctrl[mic] = hpf_ctrl.d32;
}
