 ...
 *
 * Description: Provides V120 dma register operation api \n
 * Author: @CompanyNameTag \n
 * History: \n
 * 2022-12-16， Create file. \n
 */

#ifndef HAL_DMAC_V120_REGS_OP_H
#define HAL_DMAC_V120_REGS_OP_H

#include <stdint.h>
#include <stdbool.h>
#include "common_def.h"
#include "errcode.h"
#include "hal_dmac_v120_regs_def.h"
...
/**
 * @defgroup drivers_hal_dma_v120_regs_op DMA V120 Regs Operation
...
/**
 * @brief  Set the value of @ref dma_v120_cfg_reg_data_t.dma_enable.
 * @param  [in]  val The value of @ref dma_v120_cfg_reg_data_t.dma_enable.
 */
static inline void hal_dma_cfg_set_en(uint32_t val)
{
    dma_v120_cfg_reg_data_t dma_cfg_reg;
    dma_cfg_reg.d32 = ((dma_v120_regs_t *)g_dma_regs)->configuration;
    dma_cfg_reg.b.dma_enable = val;
    ((dma_v120_regs_t *)g_dma_regs)->configuration = dma_cfg_reg.d32;
}
...
static inline void hal_dma_ch_cfg_set_ch_en(dma_channel_t channel, uint32_t val)
{
    ...
    ch_data.d32 = ((dma_v120_regs_t *)g_dma_regs)->ch_config[channel].cfg;
    ch_data.b.ch_enable = val;
    ((dma_v120_regs_t *)g_dma_regs)->ch_config[channel].cfg = ch_data.d32;
}
...
static inline uint32_t hal_dma_ctrl_get_tranf_size(dma_channel_t channel)
{
    ...
    dma_ctrl.d32 = ((dma_v120_regs_t *)g_dma_regs)->ch_config[channel].ctrl;
...
static inline void hal_dma_ctrl_set_tranf_size(dma_channel_t channel, uint32_t val)
{
    ...
    ((dma_v120_regs_t *)g_dma_regs)->ch_config[channel].ctrl = dma_ctrl.d32;
}
...
static inline void hal_dma_cfg_set_int_err_mask(dma_channel_t channel, uint32_t val)
{
    ...
    dma_cfg.d32 = ((dma_v120_regs_t *)g_dma_regs)->ch_config[channel].cfg;
    dma_cfg.b.int_err_mask = val;
    ((dma_v120_regs_t *)g_dma_regs)->ch_config[channel].cfg = dma_cfg.d32;
}
