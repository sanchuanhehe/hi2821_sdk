...
#define KEYSCAN_SIX_TYPE_COL_REG                    0x52000910
#define KEYSCAN_SIX_TYPE_ROW0_REG                   0x52000920
#define KEYSCAN_SIX_TYPE_ROW1_REG                   0x52000924
#define KEYSCAN_ENABLE_ALL_CLO                      0x7
#define KEYSCAN_ENABLE_ALL_ROW                      0xf
#define KEYSCAN_ENABLE_TWO_CLO                      0x1
#define KEYSCAN_ENABLE_THREE_ROW                    0x2
#define KEYSCAN_GPIO_NUM                            26
#define KEYSCAN_GPIO_SIX_NUM                        5
#define KEYSCAN_MAX_COL                             8
#define KEYSCAN_MAX_ROW                             16
...
/**
 * @brief  Handler of keyscan irq.
 */
int irq_keyscan_handler(int a, void *tmp);

#if defined (CONFIG_KEYSCAN_SUPPORT_SLEEP)
/**
 * @brief  Handler of keyscan sleep irq.
 */
int irq_keyscan_slp_handler(int a, void *tmp);
#endif

/**
 * @brief  Select the keyboard type.
 * @param  [in]  keys_type The keyboard_type. see @ref keyscan_keys_type_t
 */
void keyscan_porting_type_sel(keyscan_keys_type_t keys_type);

/**
 * @brief  Get the keyboard type.
 * @return The keyboard type of keyscan. see @ref keyscan_keys_type_t
 */
