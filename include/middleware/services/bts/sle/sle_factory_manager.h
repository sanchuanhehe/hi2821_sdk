 ...
 * @param [in] sle_rf_tx_start_t tx start parameter struct.
 ...
 * @param [in] sle_rf_tx_start_t 长发设置参数结构体.
 ...
 * @param [in] sle_rf_rx_start_t rx start parameter struct.
 ...
 * @param [in] sle_rf_rx_start_t 长收设置参数结构体.
