...
* Description: header file for wifi alg. \n
* Author: CompanyName \n
* History: \n
* 2022-02-22，更新文件注释 \n
* 2021-12-31，初始化该文件 \n
 ...
 * @param  [in]  macLen       Mac address len.
 ...
 * @endif
 */
errcode_t wifi_get_negotiated_rate(const uint8_t *mac, int32_t macLen, uint32_t *tx_best_rate);
