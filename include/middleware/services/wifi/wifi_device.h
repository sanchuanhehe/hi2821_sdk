...
* Description: header file for wifi device api. \n
* Author: CompanyName \n
* History: \n
* 2022-02-22，更新文件注释 \n
* 2021-12-31，初始化该文件 \n
 ...
 *
 * @param  [in]  params Parameters of scan.
 *
 * @retval ERRCODE_SUCC        Execute successfully.
 * @retval Other               Execute failed.
 * @else
 ...
 *
 * @param  [in]  params 扫描网络参数设置。
 *
 * @retval ERRCODE_SUCC 成功。
 * @retval Other        失败。
 * @endif
 */
errcode_t wifi_sta_scan_advance(const wifi_scan_params_stru *params);
 ...
 *
 * @param  [in]  fastRequest Fast connect parameters.
 *
 * @retval ERRCODE_SUCC        Execute successfully.
 * @retval Other               Execute failed.
 * @else
 ...
 *
 * @param  [in]  fastRequest 快速连接网络参数。
 *
 * @retval ERRCODE_SUCC        成功。
 * @retval Other               失败。
 * @endif
 */
errcode_t wifi_sta_fast_connect(const wifi_fast_connect_stru *fastRequest);
 ...
 *
 * @param  [in]  type WowPatternType, Wow pattern.
